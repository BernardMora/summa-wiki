...
**Phases 0-5, 9 and 11-14 done.** Indexer, CLI, and a local Next.js reader/editor styled
as an encyclopedia: masthead search, categorized sidebar, article tabs, and a
front page carrying the núcleo and the full subject index.
